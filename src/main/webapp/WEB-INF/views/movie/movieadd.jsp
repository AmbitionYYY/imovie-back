            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 添加电影 <small>Add a new movie</small></div>
                        <p class="page-header-description">在这里你可以添加一个新的电影到列表。</p>
                    </div>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="${pageContext.request.contextPath }/movie/movie-add" method="post" id="" enctype="multipart/form-data">
                                <!-- 一个input开始 -->
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">电影名称 <span class="tpl-form-line-small-title">MovieName</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="moviename" id="moviename" placeholder="请输入电影名称">
                                        </div>
                                    </div>
                                <!-- 一个input结束 -->
                                  <!-- 一个input开始 -->
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="time" id="user-name" placeholder="请输入电影时长">
                                            <small>格式：01:10:20</small>
                                        </div>
                                    </div>
                                <!-- 一个input结束 -->
                                  <!-- 一个input开始 -->
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="url" id="user-name" placeholder="请输入播放路径">
                                        </div>
                                    </div>
                                <!-- 一个input结束 -->
                                  <!-- 一个input开始 -->
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="imagepath"  id="user-name" placeholder="请输入图片路径">
                                        </div>
                                    </div>
                                <!-- 一个input结束 -->
                                  <!-- 一个input开始 -->
                                ...
                                <!-- 一个input结束 -->
                                  ...
                                  <!-- 一个input开始 -->
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="score" id="user-name" placeholder="请输入电影评分">
                                        </div>
                                    </div>
                                <!-- 一个input结束 -->
                                  <!-- 一个input开始 -->
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="director" id="user-name" placeholder="请输入电影导演">
                                        </div>
                                    </div>
                                <!-- 一个input结束 -->
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="categroy" id="user-weibo" placeholder="请添加分类用逗号隔开">
                                            <div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="des" id="user-intro" placeholder="请输入电影简介内容"></textarea>
                                        </div>
                                    </div>
